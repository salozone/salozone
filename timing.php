...
$point3 = date('H' , strtotime('16:00'));
$timeNow = date('H');
if(isset($_GET['date'])) {
	$dateValue = $_GET['date'];
}elseif($timeNow >= $point3) {
	$ts = date("d-m-Y");
...
function f2(){
	...
	window.location.href= 'timing.php?date='+x;
}
</script>
<div class="main">
					...
					<div class="col-lg-12 animate-box">
						<form action="" id="timing_form" name="timing_form" >
							<div class="_2ALjwXt8Brx2UBQJ1a6UDu _3TjTyyRTZ846xSE30xLszh _2-bFRYxiqevuTNSsQzbSOG"><div class="_32y59UEDbJyVoQag7s2FyN">
								...
								<div class="_3lEo7o-LTN2uElz2rWhPlF" id="dateOptions">
								...
								<div class='input-group date' id='datetimepicker1'>
									<input type='text' value="<?php echo $dateValue; ?>" onblur= "f2()" id="dateinput" name ="date" class="form-control"/>
