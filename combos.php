...
#combos.php
//session_start();
$pageTitle = 'Exclusive Combos';
$pageDesc = 'Exclusive Combos';
$slider = 'Exclusive Combos';
include('header.php');
?>
			...
			<div class="about-content">
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-2">
						<center><h3>EXCLUSIVE COMBOS</h3></center>
						<div class="desc">
							<p>Threading + Full Waxing(Hands+Legs+Under Arms) + Clean Up(Fruit) - Rs 395.
</p>
							<p>Threading + Full Hand Waxing + Clean Up(Fruit) - Rs 200.
</p>
							<p>Facial(Gold) + Pedicure + Manicure  - Rs 650</p>
							<p>Facial(Gold) + Pedicure - Rs 480</p>
							<p>Bleach(Oxy) + Hair Style Designer + Pedicure - Rs 380</p>
							</ul>
						</div>
					</div>
				</div>
											...
											<div class="_2eJX4e-DqumFa1IJYnSoa4">
												<div class="bV9pH8LGyb_s16WgD4UkH">
													<div class="_1mO91OZK1sBcC7N5welcDI">
														<h3>Threading + Full Hand Waxing + Clean Up(Fruit)</h3>
													</div>
												</div>
									...
									<div class="_3eR0Ps0OiYMoBRFr33yxgu">
										<div class="_20fQsT4R-EBnAmG2j8hXHy">
											<div class="_2eJX4e-DqumFa1IJYnSoa4">
												<div class="bV9pH8LGyb_s16WgD4UkH">
													<div class="_1mO91OZK1sBcC7N5welcDI">
														<h3>Facial(Gold) + Pedicure + Manicure</h3>
													</div>
												</div>
												<!--<span class="vjh4-SZW6em1Ffdp2AMqH"><span data-icon="arrow-up"></span></span>-->
											</div>
									...
									<div class="_3eR0Ps0OiYMoBRFr33yxgu">
										<div class="_20fQsT4R-EBnAmG2j8hXHy">
											<div class="_2eJX4e-DqumFa1IJYnSoa4">
												<div class="bV9pH8LGyb_s16WgD4UkH">
													<div class="_1mO91OZK1sBcC7N5welcDI">
														<h3>Bleach(Oxy) + Hair Style Designer + Pedicure</h3>
													</div>
												</div>
												<!--<span class="vjh4-SZW6em1Ffdp2AMqH"><span data-icon="arrow-up"></span></span>-->
											</div>
									...
									<div class="_3eR0Ps0OiYMoBRFr33yxgu">
										<div class="_20fQsT4R-EBnAmG2j8hXHy">
											<div class="_2eJX4e-DqumFa1IJYnSoa4">
												<div class="bV9pH8LGyb_s16WgD4UkH">
													<div class="_1mO91OZK1sBcC7N5welcDI">
														<h3>Threading + Full Waxing(Hands+Legs+Under Arms) + Clean Up(Fruit)</h3>
													</div>
												</div>
