						  ...
						  <form action="#" name="payment_form" id="payment_form">
							...
							<ul class="_2mioG8IfFu0HyLapNQp2db">
								<div class="_3pUB-LDjlpx6e9ACL8E_1x _1ztQTskd2_GRzGb0OH6YwR" style="">
									...
									echo '<div class="hPO8BoyBkYEU2ujeCWJgk _1ovga__v3v_0DJ3-9UggBS H1Lb6afUHKzH-OTelE23x" style="font-size: 14px;">
										<div class="_1kb-XXNt4wePQ_svwAQnhG">Wallet Points</div>
										<div class="_36rMyLl0yKiOS-udBUSM8a" style="color: rgb(117, 117, 117);">- ₹' . $_SESSION["wallet_pts"] . '</div>
									</div>';
									?>
