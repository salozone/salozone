...
$sql = "SELECT item,price FROM cart";
...
if ($result->num_rows > 0) {
    ...
    $message = $message."\n\nTotal : ".$amount."\n";
        ...
        $message2 = $message."Here is your requested services and other details " . $first_name . "\n\n" . $_POST['message'];
		...
		<div class="container">
			<div class="about-content">
				<div class="row animate-box">
					<div class="col-md-6">
						<div class="desc">
							<h1>Your request has been recorded our salesmanager will contact you shortly.</h1>
